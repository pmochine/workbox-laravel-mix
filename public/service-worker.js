...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)( // Cache font awesome js files
/^https:\/\/use\.fontawesome\.com/, new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.CacheFirst({
  cacheName: 'fontawesome-cache',
  plugins: [new workbox_cacheable_response__WEBPACK_IMPORTED_MODULE_2__.CacheableResponsePlugin({
    statuses: [0, 200]
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_0__.registerRoute)( // Cache font polyfill js files
/^https:\/\/polyfill\.io/, new workbox_strategies__WEBPACK_IMPORTED_MODULE_1__.CacheFirst({
...
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_4__.precacheAndRoute)([{'revision':'a1058988c8640c5e12c77bcd5374b5eb','url':'/js/app.js'},{'revision':'0e27a38e8a3bb7506430e82a54a4290b','url':'/js/manifest.js'},{'revision':'4ad809b839814d86d8d89bc6d270c386','url':'/js/vendor.js'},{'revision':'68b329da9893e34099c7d8ad5cb9c940','url':'css/app.css'}]);
            ...
            responsePromise = responsePromise.catch((err) => {
                if (true) {
                    ...
                    workbox_core_private_logger_js__WEBPACK_IMPORTED_MODULE_3__.logger.groupCollapsed(`Error thrown when responding to: ` +
                        ` ${(0,workbox_core_private_getFriendlyURL_js__WEBPACK_IMPORTED_MODULE_1__.getFriendlyURL)(url)}. Falling back to Catch Handler.`);
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/sw.js");
